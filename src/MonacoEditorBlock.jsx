...
export default function MonacoEditorBlock({ code, onChange, language }) {
  ...
  return (
    <div className="flex flex-col items-start p-4 bg-white shadow-lg rounded-xl border border-slate-200 w-full sm:w-[600px]">
      ...
      <div className="w-full min-h-[400px] rounded-lg border border-slate-300 overflow-hidden mt-3">
        <Editor
          height="400px"
